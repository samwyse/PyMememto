...
@register_as('web.archive.org')
class ArchiveOrg(Memento):
    '''
>>> obj = ArchiveOrg().get_timegate(for_uri='http://www.w3.org/TR/webarch/')
>>> obj.first
...
@register_as('timetravel.mementoweb.org')
class TimetravelMementowebOrg(Memento):
    '''
The Memento Aggregator natively supports the Memento protocol and
gathers information about Mementos across the above systems, both with
native and by-proxy support of the Memento protocol.

>>> obj = TimetravelMementowebOrg().get_timegate(for_uri='http://www.w3.org/TR/webarch/')
>>> obj.first
[('http://web.archive.org/web/20020911073933/http://www.w3.org/TR/webarch/', {'datetime': 'Wed, 11 Sep 2002 07:39:33 GMT'})]
